...
export function SEOHead() {
  useEffect(() => {
    ...
    const metaTags = [
      ...
      { property: "og:url", content: "https://thrivewebco.com" },
      { property: "og:image", content: "https://thrivewebco.com/og-image.jpg" },
      ...
      { name: "twitter:image", content: "https://thrivewebco.com/og-image.jpg" },
    ...
    const structuredData = {
      ...
      "name": "Thrive Web Co",
      "image": "https://thrivewebco.com/logo.png",
